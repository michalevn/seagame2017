	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Thêm trận đấu</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
									...
									<form role="form" lpformnum="1">
										<div class="col-lg-12">
											...
											<div class="form-group col-lg-6	">
												<label>Thời gian </label> <input class="form-control" id="date" name="matchDate" placeholder="dd/mm/yyyy" type="text"
													value="${reportDate }" required="required"
												/>
										...
										<div class="col-lg-6">
											...
											<div class="form-group">
												<label>Tỉ lệ chấp</label> <input type="number" class="form-control">
												<p class="help-block">Tỉ lệ đội 1 chấp đội 2</p>
											</div>
											<div class="form-group">
												<label>Điểm bonus thắng</label> <input type="number" class="form-control">
												<p class="help-block">Điểm bonus khi thắng</p>
											</div>
											<div class="form-group">
												<label>Điểm bonus hòa</label> <input type="number" class="form-control">
												<p class="help-block">Điểm bonus khi hòa</p>
											</div>
											<div class="form-group">
												<label>Điểm bonus thua</label> <input type="number" class="form-control">
												<p class="help-block">Điểm bonus khi thua</p>
											</div>
